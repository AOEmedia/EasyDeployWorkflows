 ...
 *
 */
class ArchivedApplicationWithNFSServerConfiguration extends ArchivedApplicationConfiguration {
	...
	public function getWorkflowClassName() {
		return 'EasyDeployWorkflows\Workflows\Application\ArchivedApplicationWithNFSServerWorkflow';
	}
